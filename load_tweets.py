...
def insert_tweet(connection,tweet):
    ...
    with connection.begin() as trans:
        ...
        connection.execute(sql, {
            'id_users':tweet['user'].get('id', None),
        ...
        connection.execute(sql, {
            ...
            'id_users':tweet.get('id_users', None),
        ...
        ########################################
        print("inserting to tweets_urls")
        try:
